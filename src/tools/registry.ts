...
const rawTools: Array<Omit<ToolDefinition, 'category'> & { category: string }> = [
  ...
  { id: 'ipv4-subnet', name: 'IPv4 子网计算器', description: '根据 CIDR 计算网络、广播和子网掩码', category: '网络', icon: Network, tags: ['ipv4', 'subnet', 'cidr'], accent: '#75e0e6', component: Ipv4SubnetPage, sourceId: 'ipv4-subnet-calculator' },
